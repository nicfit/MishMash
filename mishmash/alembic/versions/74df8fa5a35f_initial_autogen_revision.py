...
def upgrade():
    ...
    artists_t = op.create_table('artists',
                    ...
                    sa.Column('sort_name', sa.Unicode(length=128),
                              nullable=False),
                    sa.Column('date_added', sa.DateTime(), nullable=False),
                    sa.Column('origin_city', sa.Unicode(length=32),
                              nullable=True),
                    sa.Column('origin_state', sa.Unicode(length=32),
                              nullable=True),
                    sa.Column('origin_country', sa.String(length=3),
                              nullable=True),
    ...
    op.create_table('albums',
                    ...
                    sa.Column('type', sa.Enum('lp', 'ep', 'compilation',
                              ...
                              nullable=False),
                    sa.Column('date_added', sa.DateTime(), nullable=False),
                    sa.Column('release_date', mishmash.orm.AlbumDate(length=24),
                              nullable=True),
                    sa.Column('original_release_date',
                              mishmash.orm.AlbumDate(length=24), nullable=True),
